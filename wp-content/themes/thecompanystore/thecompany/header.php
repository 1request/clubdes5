            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a class="logo" href="<?php echo home_url() ?>" title="<?php bloginfo('name'); ?>">
                        <?php if (isset($rf_theme_options['cp_bloglogo_retina']) && $rf_theme_options['cp_bloglogo_retina'] != '') {
							$logoSize = getimagesize($rf_theme_options['cp_bloglogo_retina']); ?>
                            <img src="<?php echo $rf_theme_options['cp_bloglogo_retina']; ?>" style="width:<?php echo ($logoSize[0] / 2); ?>px;" alt="<?php bloginfo('name'); ?>" />
                        <?php } elseif (isset($rf_theme_options['cp_bloglogo']) && $rf_theme_options['cp_bloglogo'] != '') { ?>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <input type="text" name="s" class="s" placeholder="<?php _e('To search, click and type', 'thecompany'); ?>">
                                    </div>
                                    <div class="col-md-2 col-sm-3">
                                        <input class="button" type="submit" value="<?php _e('Search', 'thecompany'); ?>">
                                    </div>
                                    </form>
                                </div>
                            </div>
